...
func RegisterDMXHandlers(g *gin.RouterGroup, svc *fader.FadingService) {
...
func createPatchDmxHandler(svc *fader.FadingService) gin.HandlerFunc {
...
func createPatchDmxFadeHandler(svc *fader.FadingService) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func createPutDmxClearHandler(svc *fader.FadingService) gin.HandlerFunc {
	return func(c *gin.Context) {
		svc.ClearAll()
		c.String(200, "OK")
	}
