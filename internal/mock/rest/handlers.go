...
func RegisterMockHandlers(g *gin.RouterGroup, services *models_services.ApplicationServices) {
	if mock, ok := services.DMXReaderService.(*dmxmock.MockedDMXReaderService); !ok {
...
func createReadMockDmxHandler(svc dmxmock.MockedDMXReaderService) gin.HandlerFunc {
