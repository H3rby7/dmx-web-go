...
func RegisterMockHandlers(g *gin.RouterGroup, services *models_services.ApplicationServices) {
	if mock, ok := services.DMXReaderService.(*enttecmock.MockedDMXReaderService); !ok {
...
func createReadMockDmxHandler(svc enttecmock.MockedDMXReaderService) gin.HandlerFunc {
